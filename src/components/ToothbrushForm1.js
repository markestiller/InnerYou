...
const ToothbrushForm1 = ({ propTop }) => {
  ...
  return (
    <div
      className="absolute top-[150px] left-[0px] w-[541px] h-[60px] text-left text-16xl text-black font-bubblegum-sans"
...
export default ToothbrushForm1;
